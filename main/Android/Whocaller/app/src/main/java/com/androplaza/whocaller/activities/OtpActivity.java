...
import com.androplaza.whocaller.databinding.ActivityOtpBinding;
...
public class OtpActivity extends AppCompatActivity {
    ...
    public boolean validation1() {
        ...
        String nationalFormat = PhoneNumberUtils.toNationalFormat("+" + countryCode + binding.edMobile.getText().toString(), "US");
    ...
    private void saveUserToDatabase(String firstName, String lastName, String email, String phone, String password) {
        String nationalFormat = PhoneNumberUtils.toNationalFormat(phone, "US");
        if (nationalFormat != null) {
