...
@section('content')
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">Provide your username of codecanyon & the purchase code </p>

            <form method="POST" action="{{ route('save.data', ['token' => bcrypt('step_3')]) }}">
                @csrf
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-primary px-sm-5">Continue</button>
                </div>
